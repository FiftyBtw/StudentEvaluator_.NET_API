...
public class StubbedContext : LibraryContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TeacherEntity>().HasData(
            new TeacherEntity { Id = "1", UserName = "ProfDupont", PasswordHash = "$2y$10$kx6xmLJEiXGkVroyBT0CQetdvYRwK5EnuyUntvL3BxE5PHMBB8txe" },
            new TeacherEntity { Id = "2", UserName = "ProfDurand", PasswordHash = "$2y$10$v.CNQT.HevXlQcnJRh8p.u6MPlRUEWzKD9tDW.pT820nYkiUi8gEy" },
            new TeacherEntity { Id = "3", UserName = "ProfMartin", PasswordHash = "$2y$10$D9FztiIDadYSmCgy1gy.N.V.rwCTCGAvYckGacxpbWocS7DETTn8." },
            new TeacherEntity { Id = "4", UserName = "ProfPetit", PasswordHash = "$2y$10$xL5hLjLYUphj2b2zFszg8.qiZCxpChGMmyOzVguqXYK7PoJrEPIOi" },
            new TeacherEntity { Id = "5", UserName = "ProfLeroy", PasswordHash = "$2y$10$uohwx42x7pZH/weZFgBSdu5A8ZNSgvxYrzH7v8QJgUnpfM8FWL8fG" }
        );
        ...
        modelBuilder.Entity<LessonEntity>().HasData(
            new LessonEntity { Id=1 , Classroom="A23", CourseName="Introduction au SQL",Start= new DateOnly(2023, 10, 30).ToDateTime(new TimeOnly(9,0)), End= new DateOnly(2023, 10, 30).ToDateTime(new TimeOnly(11, 0)), GroupYear=1, GroupNumber=2, TeacherEntityId="1" },
            new LessonEntity { Id = 2, Classroom = "B23", CourseName = "Bases du développement Web", Start = new DateOnly(2023, 10, 30).ToDateTime(new TimeOnly(14, 0)) , End = new DateOnly(2023, 10, 30).ToDateTime(new TimeOnly(16, 0)), GroupYear = 1, GroupNumber = 3, TeacherEntityId = "2" },
            new LessonEntity { Id = 3, Classroom = "Amphi A", CourseName = "Fondamentaux de JavaScript", Start = new DateOnly(2023, 11, 02).ToDateTime(new TimeOnly(10, 0)), End = new DateOnly(2023, 11, 02).ToDateTime( new TimeOnly(12, 0)), GroupYear = 1, GroupNumber = 1, TeacherEntityId = "3" },
            new LessonEntity { Id = 4, Classroom = "A22", CourseName = "Conception de Bases de Données", Start = new DateOnly(2023, 11, 03).ToDateTime(new TimeOnly(13, 30)), End = new DateOnly(2023, 11, 03).ToDateTime(new TimeOnly(15, 30)), GroupYear = 1, GroupNumber = 2, TeacherEntityId = "1" },
            new LessonEntity { Id = 5, Classroom = "A19", CourseName = "Programmation en Python", Start = new DateOnly(2023, 11, 05).ToDateTime( new TimeOnly(9, 30)), End = new DateOnly(2023, 11, 05).ToDateTime( new TimeOnly(11, 30)), GroupYear = 2, GroupNumber = 3, TeacherEntityId = "2" },
            new LessonEntity { Id = 6, Classroom = "B23", CourseName = "Bases du HTML", Start = new DateOnly(2023, 11, 07).ToDateTime( new TimeOnly(10, 30)), End = new DateOnly(2023, 11, 07).ToDateTime( new TimeOnly(12, 30)), GroupYear = 1, GroupNumber = 3, TeacherEntityId = "1" },
            new LessonEntity { Id = 7, Classroom = "A12", CourseName = "Stylisation CSS", Start = new DateOnly(2023, 11, 08).ToDateTime( new TimeOnly(14, 30)), End = new DateOnly(2023, 11, 08).ToDateTime( new TimeOnly(16, 30)), GroupYear = 2, GroupNumber = 4, TeacherEntityId = "2" },
            new LessonEntity { Id = 8, Classroom = "B20", CourseName = "Programmation en Java", Start = new DateOnly(2023, 11, 10).ToDateTime( new TimeOnly(11, 0)), End = new DateOnly(2023, 11, 10).ToDateTime( new TimeOnly(13, 0)), GroupYear = 1, GroupNumber = 4, TeacherEntityId = "1" },
            new LessonEntity { Id = 9, Classroom = "A21", CourseName = "Sécurité Réseau", Start = new DateOnly(2023, 11, 12).ToDateTime(new TimeOnly(10, 0)), End = new DateOnly(2023, 11, 12).ToDateTime(new TimeOnly(12, 0)), GroupYear = 2, GroupNumber = 5, TeacherEntityId = "2" },
            new LessonEntity { Id = 10, Classroom = "Amphi A", CourseName = "Apprentissage Automatique", Start = new DateOnly(2023, 11, 14).ToDateTime(new TimeOnly(15, 0)), End = new DateOnly(2023, 11, 14).ToDateTime(new TimeOnly(17, 0)), GroupYear = 1, GroupNumber = 5, TeacherEntityId = "1" },
            new LessonEntity { Id = 11, Classroom = "Amphi B", CourseName = "Intelligence Artificielle", Start = new DateOnly(2023, 11, 16).ToDateTime(new TimeOnly(13, 30)), End = new DateOnly(2023, 11, 16).ToDateTime(new TimeOnly(15, 30)), GroupYear = 2, GroupNumber = 6, TeacherEntityId = "2" }

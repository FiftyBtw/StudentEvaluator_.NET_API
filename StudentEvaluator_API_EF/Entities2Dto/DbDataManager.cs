    ...
    /*IUserService<UserDto,LoginDto, LoginResponseDto>,*/ ITemplateService<TemplateDto>, ILessonService<LessonDto,LessonReponseDto>, IEvaluationService<EvaluationDto,EvaluationReponseDto>
{
    ...
    public async Task<PageReponse<StudentDto>> GetStudents(int index = 0, int count = 0)
    {
    ...
    public async Task<PageReponse<GroupDto>> GetGroups(int index = 0, int count = 0)
    {
    ...
    */
    ...
    public async Task<PageReponse<TemplateDto>> GetTemplatesByUserId(string userId, int index = 0, int count = 0)
    {
    ...
    public async Task<PageReponse<TemplateDto>> GetEmptyTemplatesByUserId(string userId, int index = 0, int count = 0)
    {
    ...
    public Task<PageReponse<LessonReponseDto>> GetLessons(int index = 0, int count = 0)
    {
    ...
    /// <param name="count">The number of lessons per page.</param>
    /// <returns>A task representing the asynchronous operation, returning a page response containing the lessons.</returns>
    public Task<PageReponse<LessonReponseDto>> GetLessonsByTeacherId(string userId, int index = 0, int count = 0)
    {
    ...
    public Task<PageReponse<EvaluationReponseDto>> GetEvaluations(int index = 0, int count = 0)
    {
    ...
    /// <param name="count">The number of evaluations per page.</param>
    /// <returns>A task representing the asynchronous operation, returning a page response containing the evaluations.</returns>
    public Task<PageReponse<EvaluationReponseDto>> GetEvaluationsByTeacherId(string userId, int index = 0, int count = 0)
    {
